...
class PromptToolkitSSHSession(asyncssh.SSHServerSession):
    ...
    def __init__(self, interact: Callable[[PromptToolkitSSHSession], Coroutine[Any, Any, None]], *, enable_cpr: bool) -> None:
...
class PromptToolkitSSHServer(asyncssh.SSHServer):
    ...
    def __init__(self, interact: Callable[[PromptToolkitSSHSession], Coroutine[Any, Any, None]], *, enable_cpr: bool=True) -> None:
        self.interact = interact
        self.enable_cpr = enable_cpr