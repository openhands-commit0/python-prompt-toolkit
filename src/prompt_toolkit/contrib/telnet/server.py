...
class TelnetConnection:
    ...
    def __init__(self, conn: socket.socket, addr: tuple[str, int], interact: Callable[[TelnetConnection], Coroutine[Any, Any, None]], server: TelnetServer, encoding: str, style: BaseStyle | None, vt100_input: PipeInput, enable_cpr: bool=True) -> None:
        self.conn = conn
        self.addr = addr
...
")
    ...
    def __init__(self, host: str='127.0.0.1', port: int=23, interact: Callable[[TelnetConnection], Coroutine[Any, Any, None]]=_dummy_interact, encoding: str='utf-8', style: BaseStyle | None=None, enable_cpr: bool=True) -> None:
        self.host = host
        self.port = port
        self.interact = interact
        self.encoding = encoding
