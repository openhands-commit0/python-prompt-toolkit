...
class COORD(Structure):
    ...
    def __repr__(self) -> str:
        return '{}(X={!r}, Y={!r}, type_x={!r}, type_y={!r})'.format(self.__class__.__name__, self.X, self.Y, type(self.X), type(self.Y))
...
EventTypes = {1: 'KeyEvent', 2: 'MouseEvent', 4: 'WindowBufferSizeEvent', 8: 'MenuEvent', 16: 'FocusEvent'}
...
class CONSOLE_SCREEN_BUFFER_INFO(Structure):
    ...
    def __repr__(self) -> str:
        return 'CONSOLE_SCREEN_BUFFER_INFO({!r},{!r},{!r},{!r},{!r},{!r},{!r},{!r},{!r},{!r},{!r})'.format(self.dwSize.Y, self.dwSize.X, self.dwCursorPosition.Y, self.dwCursorPosition.X, self.wAttributes, self.srWindow.Top, self.srWindow.Left, self.srWindow.Bottom, self.srWindow.Right, self.dwMaximumWindowSize.Y, self.dwMaximumWindowSize.X)
