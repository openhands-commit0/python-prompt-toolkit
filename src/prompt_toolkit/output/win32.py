...
class Win32Output(Output):
    ...
    def __init__(self, stdout: TextIO, use_complete_width: bool=False, default_color_depth: ColorDepth | None=None) -> None:
...
def _create_ansi_color_dict(color_cls: type[FOREGROUND_COLOR] | type[BACKGROUND_COLOR]) -> dict[str, int]:
